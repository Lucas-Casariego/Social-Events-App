...
Instead of using Semantic UI, I opted to use Material UI for its rich collection of customizable components that allowed me to create a consistent design across the app.
